...
V1（M0 骨架门禁 · M1 数据层 · M2 任务引擎 · M3 八大页面 · M4 更新发布链 · M5 收尾）已完成；
其后 v0.3.0 UX 优化 41 项 · v0.5.0 生成页重构 · v0.7.0 发布与资产管理模块 ·
v0.9.0 发布模块优化 35 项 · v0.10.0 密钥存储迁移 · v0.13.0 用途标签与图生视频包 ·
v0.14.0 参考图库独立。**完整记录与设计取舍见 [CLAUDE.md](CLAUDE.md) 的「里程碑进度」**
（V1 四份规划文档已删除，内容浓缩于此）。
